...
while true; do
    inotifywait -qe modify $1 ninjal-template.pandoc bibliography/doctors-bibliography.bib # images/*
    pandoc --no-wrap --highlight-style=kate --template=ninjal-template.pandoc --biblatex --latex-engine=lualatex \
           -f markdown \
           --smart \
